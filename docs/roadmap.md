...
- [x] Fase 6 — Machine Learning para RUL (Linear / RF / GBM quantile)
...
- [x] Fase 10 — Dashboard unificado (Streamlit: DT · Fleet · ML · Monte Carlo)
...
- [ ] Deep learning para RUL (LSTM/Transformer)
